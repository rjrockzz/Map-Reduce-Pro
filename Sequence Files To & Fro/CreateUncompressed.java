...
public class CreateUncompressed extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    ...
    job.setJarByClass(CreateUncompressed.class);
  ...
  public static void main(String[] args) throws Exception {
    int exitCode = ToolRunner.run(new Configuration(), new CreateUncompressed(), args);
