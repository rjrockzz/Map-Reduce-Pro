...
public class CreateCompressed extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    ...
    job.setJarByClass(CreateCompressed.class);
  ...
  public static void main(String[] args) throws Exception {
    int exitCode = ToolRunner.run(new Configuration(), new CreateCompressed(), args);
