...
public class AvgToolDriver extends Configured implements Tool {
	...
	public static void main(String[] args) throws Exception {
		...
		int exitCode = ToolRunner.run(conf, new AvgToolDriver(), args);
	...
	public int run(String[] args) throws Exception {
		 ...
		 */
		job.setJarByClass(AvgToolDriver.class);
		 ...
		 */
		job.setMapperClass(AvgToolMapper.class);
		job.setReducerClass(AvgToolReducer.class);
